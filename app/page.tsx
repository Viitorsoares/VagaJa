...
export default function Home() {
  return (
    <main className="h-screen w-full px-5 bg-fundo">
      <section>
        <div>
          <h1 className="pt-15 text-branco text-center text-4xl font-extrabold leading-tight">Estacionamento <br /> urbano <br />
